    ...
    <div className="flex flex-col">
      ...
      <div className="flex bg-slate-900">
        <svg
          ...
          width={((eval_ * 10 + 100) / 2).toPrecision(2) + "%"}
          height={30}
        >
          <rect className="w-full" height={30} />
        </svg>
      </div>
      <div className="flex px-16 py-4 gap-8 max-h-[620px]">
        <div className="flex flex-col gap-4 text-slate-50">
          <div className="flex gap-1 border-b border-slate-600">
            <button
              onClick={() => setCurrTab(0)}
              className={
                "border-t border-x border-transparent hover:border-slate-600 rounded-t p-2 transition duration-100" +
                (currTab === 0 ? " bg-slate-600" : "")
              }
            >
              Library
            </button>
          ...
          <div
            className={
              "flex min-h-0 flex-col gap-2 text-slate-50 overflow-y-scroll" +
              (currTab === 0 ? " flex" : " hidden")
            }
          >
            ...
            <button className="flex justify-between bg-slate-600 hover:bg-slate-500 p-2 rounded">
              Final exam
              <span className="flex text-slate-400">12/24/2022</span>
            </button>
            <button className="flex justify-between bg-slate-600 hover:bg-slate-500 p-2 rounded">
              Untitled game
              <span className="flex text-slate-400">12/29/2022</span>
          ...
          <div
            className={"flex-col gap-4" + (currTab === 1 ? " flex" : " hidden")}
          >
                  ...
                  <div className="flex flex-col text-slate-50 px-4">
                    ...
                    <label className="flex gap-2 items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setImportSource(
                            e.target.value === "lichess.org" ? 1 : -1
                          )
                        }
                      />
                      Lichess.org
                ...
                innerJSX={
                  <div className="flex flex-1 flex-col px-4 pb-4 gap-2">
                    <input
                      ...
                      className="p-1 bg-slate-500 rounded"
                    />
                    <div className="flex flex-col flex-1 gap-2">
                      <button className="flex justify-center bg-teal-600 text-slate-50 p-2 rounded hover:bg-teal-700 transition duration-100 disabled:opacity-50 disabled:hover:bg-teal-600">
                        Fetch games
                      </button>
                      <button className="flex justify-center bg-green-600 text-slate-50 p-2 rounded hover:bg-green-700 transition duration-100 disabled:opacity-50 disabled:hover:bg-green-700">
                        Most recent
                      </button>
                    </div>
                  </div>
          ...
          <div
            className={
              "flex-col gap-4 rounded overflow-hidden" +
              (currTab === 2 ? " flex" : " hidden")
            }
          >
        ...
        <div className="flex border-slate-500 border rounded p-4 py-2 flex-1 flex-col gap-2">
          <Chessboard
            ...
            position={move === null ? FEN.start : move.fen}
          ...
          <div className="flex flex-1 gap-2 p-2">
            ...
            <button
              onClick={nextMove}
              className="rounded-full hover:bg-slate-600 transition duration-100"
            >
              <svg
                className="fill-slate-50"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-1 flex-col gap-2 text-slate-300">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col text-sm bg-slate-600 rounded">
                <div className="flex p-1 ">... e4 e5</div>
