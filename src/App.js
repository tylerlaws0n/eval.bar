...
function App() {
    ...
    return (
        <div className="flex flex-col gap-4">
            <nav className="flex bg-slate-600 p-4 text-slate-50">
            ...
            <div className="flex px-16 gap-8">
                <div className="flex border-slate-500 border rounded p-4 py-2 flex-1 flex-col gap-2">
                    <Chessboard boardWidth={500} customLightSquareStyle={{backgroundColor: "#cbd5e1"}} customDarkSquareStyle={{backgroundColor: "#64748b"}} boardOrientation={orientedWhite ? "white" : "black"}/>
                ...
                <div className="flex flex-col gap-4 text-slate-50">
                    ...
                    <div className={"flex flex-1 gap-4" + (currTab === 0 ? " flex" : " hidden")}>
                        <div className="flex flex-col w-5 rounded">
                            <div className="flex flex-1 bg-slate-900 rounded-t">
                                &nbsp;
                            </div>
                            <div className="flex flex-1 bg-slate-50 rounded-b">
                                &nbsp;
                            </div>
                        </div>
                        <div className="flex flex-1 flex-col gap-2">
                            ...
                            <span className="flex bg-slate-900 rounded-l p-2 text-xl font-bold">
                                +9.6
                            </span>
                                    <div className="flex flex-1 p-1">
                                        <div className="flex flex-1 flex-col justify-center">
                                            <span className="text-xs font-bold text-slate-400">Stockfish 15</span>
                                            <span className="text-sm text-slate-300">Depth 20</span>
                                        </div>
                            ...
                            <div className="flex bg-slate-600 rounded">
                                <div className="flex flex-col py-2 text-slate-300 rounded-l border-slate-500 border-r w-1/6 items-center">
                                    <span>1</span>
                                    <span>2</span>
                                    <span>3</span>
                                    <span>4</span>
                                </div>
                                <div className="flex flex-1 flex-col py-2 rounded-r">
                                    <div className="flex justify-around"><span>e4</span><span>e5</span></div>
                                    <div className="flex justify-around"><span>Nf3</span><span>Nc6</span></div>
                                    <div className="flex justify-around"><span>Bc4</span><span>Bc5</span></div>
                                    <div className="flex justify-around"><span>0-0</span><span>Nf6</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-2">
                    ...
                    <div className="flex flex-col gap-2 text-slate-50 overflow-y-scroll">
                        <button className="flex justify-between bg-slate-500 hover:bg-slate-600 p-2 rounded">
                            Untitled game
